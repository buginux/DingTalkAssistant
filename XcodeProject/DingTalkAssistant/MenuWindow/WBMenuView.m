...
- (void)commonInit {
    ...
    closeButton.titleLabel.font = [UIFont systemFontOfSize:12.0];
    ...
    closeButton.frame = CGRectMake(CGRectGetWidth(menuButton.frame) + 8.0, CGRectGetMinY(menuButton.frame), closeButtonSize.width, closeButtonSize.height);
}
